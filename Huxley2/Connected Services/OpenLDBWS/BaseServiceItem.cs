...
namespace OpenLDBWS
{
    public partial class BaseServiceItem
    {
        ...
        public string ServiceIdUrlSafe => WebEncoders.Base64UrlEncode(Convert.FromBase64String(serviceIDField.PadRight(serviceIDField.Length + (serviceIDField.Length * 3) % 4, '=')));
    }
}
